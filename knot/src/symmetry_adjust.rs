...
// /// The state of a gradient descent algorithm attempting to minimize the misalignment of a joint
// /// chain's connection to its neighbor, taking into account symmetry, by adjusting the position
// /// of the joint chain in space.
// #[derive(Clone, Copy, Debug)]
...
// impl Optimizer {
//     pub fn new(opt_params: OptimizationParams, problem: Problem, initial: Vars) -> Optimizer {
//         Optimizer {
//             opt_params,
//             problem,
//             curr_vars: initial,
...
//     pub fn curr_vars(&self) -> &Vars {
//         &self.curr_vars
//     }

//     /// Perform a single optimization step
//     pub fn optimize(&mut self) {
//         let differential = self.curr_vars.differential(
//             self.opt_params.radius_step,
//             self.opt_params.radial_angle_step,
//             &|vars| self.problem.cost(vars),
//         );
//         self.problem.apply_step(
//             &mut self.curr_vars,
//             &differential.scale(-self.opt_params.descent_rate),
//         );
//     }
// }
